    ...
    if len(message.text) > 2:    
        ...
        if len(btn) > 10: 
            ...
            await message.reply_text(
                f"<b> Join our channels to access the files😜..Here is the result for your request 😇 {message.text}</b>",
    ...
    if query.message.reply_to_message.from_user.id == query.from_user.id:
        ...
        if query.data.startswith("next"):
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("🙃 GO TO NEXTNEXT PAGE 🙃", callback_data=f"next_{int(index)-1}_{keyword}")]
                )
                buttons.append(
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("MY DEV 👨‍🔬", url="https://t.me/Millieeleven")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("🥰 SUPPORT 🥰", url="https://t.me/Rahulthrilok")]
            ])
        ...
        await query.answer("വലതും കിട്ടിയെങ്കിൽ എന്നോടും കൂടി പറ 😂😂",show_alert=True)
